...
for x in range(15):
    ...
    for k in range(-4, 16):
        ...
        for i in range(BPSK.total):
            for j in range(BPSK.M ** 3):
                BPSK.rt.append((BPSK.s[j][0] * BPSK.cDynamic[0]) + (BPSK.s[j][1] * BPSK.cDynamic[1]) + (
                        BPSK.s[j][2] * BPSK.cDynamic[2]) + (
                                       BPSK.sigma * (complex(random.gauss(0, 1), random.gauss(0, 1)))))
                BPSK.delta[j][i] = abs(
                    BPSK.rt[i] - ((BPSK.s[j][0] * BPSK.cDynamic[0]) + (BPSK.s[j][1] * BPSK.cDynamic[1]) + (
                            BPSK.s[j][2] * BPSK.cDynamic[2]))) ** 2
            temp = math.inf
    ...
    BPSK.SERn[k] = BPSK.symErrorCount
    BPSK.SERd[k] = BPSK.total
    BPSK.SER[k] = BPSK.SERn[k] / BPSK.SERd[k]
...
for x in range(15):
    ...
    for k in range(-4, 16):
        ...
        for i in range(int(QAM4.total / 2)):
            for j in range(QAM4.M ** 3):
                QAM4.rt.append((QAM4.s[j][0] * QAM4.cDynamic[0]) + (QAM4.s[j][1] * QAM4.cDynamic[1]) + (
                        QAM4.s[j][2] * QAM4.cDynamic[2]) + (
                                       QAM4.sigma * (complex(random.gauss(0, 1), random.gauss(0, 1)))))
                QAM4.delta[j][i] = abs(
                    QAM4.rt[i] - ((QAM4.s[j][0] * QAM4.cDynamic[0]) + (QAM4.s[j][1] * QAM4.cDynamic[1]) + (
                            QAM4.s[j][2] * QAM4.cDynamic[2]))) ** 2
            temp = math.inf
    ...
    QAM4.BERn[k] += QAM4.bitErrorCount
    QAM4.BERd[k] += QAM4.total
    QAM4.BER[k] = QAM4.BERn[k] / QAM4.BERd[k]
    #
...
for x in range(15):
    ...
    for k in range(-4, 16):
        ...
        for i in range(int(PSK8.total / 3)):
            for j in range(PSK8.M ** 3):
                PSK8.rt.append((PSK8.s[j][0] * PSK8.cDynamic[0]) + (PSK8.s[j][1] * PSK8.cDynamic[1]) + (
                        PSK8.s[j][2] * PSK8.cDynamic[2]) + (
                                       PSK8.sigma * (complex(random.gauss(0, 1), random.gauss(0, 1)))))
                PSK8.delta[j][i] = abs(
                    PSK8.rt[i] - ((PSK8.s[j][0] * PSK8.cDynamic[0]) + (PSK8.s[j][1] * PSK8.cDynamic[1]) + (
                            PSK8.s[j][2] * PSK8.cDynamic[2]))) ** 2
            temp = math.inf
    ...
    PSK8.BERn[k] += PSK8.bitErrorCount
    PSK8.BERd[k] += PSK8.total
    PSK8.BER[k] = PSK8.BERn[k] / PSK8.BERd[k]
