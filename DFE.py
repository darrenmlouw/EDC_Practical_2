...
# Initialize
# ----------------------------------------------------------------
BPSK = Multipath(20000, 2)
QAM4 = Multipath(40000, 4)
PSK8 = Multipath(60000, 8)
# ----------------------------------------------------------------
# Set Bits and Symbols
# ----------------------------------------------------------------
# Setting bits and symbols for BPSK
...
# Setting bits and symbols for 4QAM
duo = [0] * 2
...
# Setting bits and symbols for 8PSK
tri = [0] * 3
